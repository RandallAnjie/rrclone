...
const DefaultRoot = "https://www.terabox.com"

type File struct {
	IDField     string    `json:"path"`
	NameField   string    `json:"server_filename"`
...
func (f File) IsDir() bool         { return int64(f.IsdirRaw) == 1 }
