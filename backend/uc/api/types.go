// Package api contains types for the UC Drive web API.
package api

import "time"

const (
	// DefaultRoot is https://pc-api.uc.cn/1/clouddrive
	DefaultRoot = "https://pc-api.uc.cn/1/clouddrive"
	// DefaultReferer is the UC Drive web referer.
	DefaultReferer = "https://drive.uc.cn"
	// DefaultUA is a UC desktop client user agent.
	DefaultUA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) uc-cloud-drive/2.5.20 Chrome/100.0.4896.160 Safari/537.36"
)

// BaseResp is the common envelope for UC JSON.
